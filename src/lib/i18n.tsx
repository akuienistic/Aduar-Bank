...
export const dict: Dict = {
  ...
  "hero.subtitle": {
    en: "Collateral-free loans for rural farmers, market women, and small business owners, built on trust. NOTE that legal documents and proof of identity are required.",
